...
public class PaymentService
{
    ...
    public async Task<(bool isSuccess, string? failMessage)> CreateCreate(PaymentCreateRequestDto request)
    {
        var response = await _client.PostAsJsonAsync<PaymentCreateRequestDto>("api/PaymentProcess/Create",request);
        var responseContent =
